    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-16 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-accord-dark">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/kontakt"
              className="bg-accord text-white px-6 py-3 rounded-md hover:bg-accord-dark transition-colors"
            >
              Kontakt aufnehmen
            </Link>
            ...
            <Link
              href="/angebote"
              className="border border-accord text-accord px-6 py-3 rounded-md hover:bg-background-dark transition-colors"
            >
              Unsere Angebote
            </Link>
          </div>
      ...
      <section className="py-16 px-4 bg-background-dark">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-12 text-center text-accord-dark">
            Unsere Angebote
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow bg-white">
              <div className="w-12 h-12 bg-accord-light/20 rounded-full flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-accord" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold mb-2 text-accord-dark">Seelsorgliche Begleitung</h3>
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow bg-white">
              ...
              <h3 className="text-xl font-bold mb-2 text-accord-dark">Familienberatung</h3>
              <p className="text-gray-600">
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow bg-white">
              ...
              <h3 className="text-xl font-bold mb-2 text-accord-dark">Bildungsangebote</h3>
              <p className="text-gray-600">
          ...
          <div className="text-center mt-12">
            <Link
              href="/angebote"
              className="text-accord font-medium hover:text-accord-dark hover:underline"
            >
